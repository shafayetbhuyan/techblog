...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Admin admin= dao.getAdminByEmailAndPassword(adminEmail, adminPassword);
            
            if(admin==null){
                // Error, Admin not found/ wrong userEmal or userPassword
                
                //out.println("Invalid Admin email or password, please try again");
                Message msg= new Message("Invalid Admin Email or Password", "error", "alert-danger");
